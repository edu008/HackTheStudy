...
def get_memory_usage() -> Tuple[int, float]:
    ...
    try:
        ...
        logger.error("Fehler bei der Ermittlung des Speicherverbrauchs: %s", str(e))
        return 0, 0
...
def get_cpu_usage() -> float:
    ...
    try:
        ...
        logger.error("Fehler bei der Ermittlung der CPU-Nutzung: %s", str(e))
        return 0
...
def get_open_file_descriptors() -> List[int]:
    ...
    try:
        ...
        logger.error("Fehler beim Abrufen der offenen Dateideskriptoren: %s", str(e))
        return []
...
def get_system_info() -> dict:
    ...
    try:
        ...
        logger.error("Fehler beim Sammeln von Systeminformationen: %s", str(e))
        return {"error": str(e)}
