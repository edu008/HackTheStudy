...
from ..utils import query_chatgpt, detect_language, check_and_manage_user_sessions
from core.models import Upload, Topic
...
def process_topic_response(response, language='en'):
    ...
    """
    logger.info(f"Processing OpenAI response for topics:\n{response}")
    new_topics = []
    new_connections = []
